...
protected: 						// local utilities
	...
	void destroyLinkedBinaryTree(Node* v);	// helps destroy tree
	void avlCorrection(Node* v); //sets the avl values after insert
	void rightRot(Node* v);      //right rotates around a node
	void leftRot(Node* v);       // left rotates around a node
